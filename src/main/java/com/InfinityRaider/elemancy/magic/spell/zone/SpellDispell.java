...
public final class SpellDispell extends SpellZone {
    public SpellDispell() throws DuplicateSpellException {
        super(Element.LIFE, Element.LIFE, Names.Spells.DISPELL);
    }
