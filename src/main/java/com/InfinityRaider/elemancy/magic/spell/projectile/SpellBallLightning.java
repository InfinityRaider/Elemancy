...
public final class SpellBallLightning extends SpellProjectile {
    public SpellBallLightning() throws DuplicateSpellException {
        super(Element.FIRE, Element.AIR, Names.Spells.BALL_LIGHTNING);
    }
