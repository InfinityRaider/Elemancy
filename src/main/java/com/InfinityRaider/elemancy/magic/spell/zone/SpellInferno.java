...
public final class SpellInferno extends SpellZone {
    public SpellInferno() throws DuplicateSpellException {
        super(Element.FIRE, Element.AIR, Names.Spells.INFERNO);
    }
