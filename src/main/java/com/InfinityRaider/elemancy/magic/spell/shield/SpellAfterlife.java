...
public final class SpellAfterlife extends SpellShield {
    public SpellAfterlife() throws DuplicateSpellException {
        super(Element.DEATH, Element.DEATH, Names.Spells.AFTERLIFE);
    }
