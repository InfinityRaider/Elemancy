...
public final class SpellColdEmbrace extends SpellBeam {
    public SpellColdEmbrace() throws DuplicateSpellException {
        super(Element.WATER, Element.LIFE, Names.Spells.COLD_EMBRACE);
    }
