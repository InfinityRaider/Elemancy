...
public final class SpellSpawnWater extends SpellProjectile {
    public SpellSpawnWater() throws DuplicateSpellException {
        super(Element.WATER, Element.WATER, Names.Spells.SPAWN_WATER);
    }
