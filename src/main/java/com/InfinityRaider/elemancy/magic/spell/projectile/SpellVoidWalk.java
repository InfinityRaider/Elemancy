...
public final class SpellVoidWalk extends SpellProjectile {
    public SpellVoidWalk() throws DuplicateSpellException {
        super(Element.DEATH, Element.DEATH, Names.Spells.VOID_WALK);
    }
