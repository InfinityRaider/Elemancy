...
public final class SpellHealingBeam extends SpellBeam {
    public SpellHealingBeam() throws DuplicateSpellException {
        super(Element.LIFE, Element.LIFE, Names.Spells.HEALING_BEAM);
    }
