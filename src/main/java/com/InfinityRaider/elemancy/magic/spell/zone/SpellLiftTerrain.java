...
public final class SpellLiftTerrain extends SpellZone {
    public SpellLiftTerrain() throws DuplicateSpellException {
        super(Element.EARTH, Element.AIR, Names.Spells.LIFT_TERRAIN);
    }
