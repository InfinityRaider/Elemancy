...
public final class SpellDrownEntity extends SpellBeam {
    public SpellDrownEntity() throws DuplicateSpellException {
        super(Element.WATER, Element.EARTH, Names.Spells.DROWN_ENITTY);
    }
