...
public final class SpellLavaWalking extends SpellShield {
    public SpellLavaWalking() throws DuplicateSpellException {
        super(Element.FIRE, Element.EARTH, Names.Spells.LAVA_WALKING);
    }
