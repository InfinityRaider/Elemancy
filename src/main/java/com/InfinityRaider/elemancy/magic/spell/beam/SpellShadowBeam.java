...
public final class SpellShadowBeam extends SpellBeam {
    public SpellShadowBeam() throws DuplicateSpellException {
        super(Element.DEATH, Element.DEATH, Names.Spells.SHADOW_BEAM);
    }
