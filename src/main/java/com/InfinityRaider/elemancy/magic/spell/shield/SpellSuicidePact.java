...
public final class SpellSuicidePact extends SpellShield {
    public SpellSuicidePact() throws DuplicateSpellException {
        super(Element.EARTH, Element.DEATH, Names.Spells.SUICIDE_PACT);
    }
