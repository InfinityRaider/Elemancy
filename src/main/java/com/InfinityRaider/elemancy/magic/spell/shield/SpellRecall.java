...
public final class SpellRecall extends SpellShield {
    public SpellRecall() throws DuplicateSpellException {
        super(Element.EARTH, Element.LIFE, Names.Spells.RECALL);
    }
