...
public final class SpellFrostShield extends SpellShield {
    public SpellFrostShield() throws DuplicateSpellException {
        super(Element.WATER, Element.WATER, Names.Spells.FROST_SHIELD);
    }
