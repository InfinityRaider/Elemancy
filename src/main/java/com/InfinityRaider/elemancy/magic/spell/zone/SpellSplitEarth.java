...
public final class SpellSplitEarth extends SpellZone {
    public SpellSplitEarth() throws DuplicateSpellException {
        super(Element.EARTH, Element.EARTH, Names.Spells.SPLIT_EARTH);
    }
