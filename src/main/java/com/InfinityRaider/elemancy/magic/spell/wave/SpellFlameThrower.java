...
public final class SpellFlameThrower extends SpellWave {
    public SpellFlameThrower() throws DuplicateSpellException {
        super(Element.FIRE, Element.FIRE, Names.Spells.FLAMETHROWER);
    }
