...
public final class SpellStoneDaggers extends SpellProjectile {
    public SpellStoneDaggers() throws DuplicateSpellException {
        super(Element.EARTH, Element.EARTH, Names.Spells.STONE_DAGGERS);
    }
