...
public final class SpellDisarm extends SpellProjectile {
    public SpellDisarm() throws DuplicateSpellException {
        super(Element.DEATH, Element.DEATH, Names.Spells.DISARM);
    }
