...
public final class SpellTsunami extends SpellWave {
    public SpellTsunami() throws DuplicateSpellException {
        super(Element.WATER, Element.WATER, Names.Spells.TSUNAMI);
    }
