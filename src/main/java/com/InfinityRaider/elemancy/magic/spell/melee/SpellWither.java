...
public final class SpellWither extends SpellMelee {
    public SpellWither() throws DuplicateSpellException {
        super(Element.DEATH, Element.DEATH, Names.Spells.WITHER);
    }
