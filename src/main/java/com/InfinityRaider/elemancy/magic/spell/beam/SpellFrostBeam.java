...
public final class SpellFrostBeam extends SpellBeam {
    public SpellFrostBeam() throws DuplicateSpellException {
        super(Element.WATER, Element.DEATH, Names.Spells.FROST_BEAM);
    }
