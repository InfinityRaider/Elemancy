...
public final class SpellConjureMeteor extends SpellBeam {
    public SpellConjureMeteor() throws DuplicateSpellException {
        super(Element.FIRE, Element.AIR, Names.Spells.CONJURE_METEOR);
    }
