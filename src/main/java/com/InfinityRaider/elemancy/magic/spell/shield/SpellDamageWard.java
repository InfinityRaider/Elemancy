...
public final class SpellDamageWard extends SpellShield {
    public SpellDamageWard() throws DuplicateSpellException {
        super(Element.LIFE, Element.DEATH, Names.Spells.DAMAGE_WARD);
    }
