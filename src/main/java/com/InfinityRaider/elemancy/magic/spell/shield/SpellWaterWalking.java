...
public final class SpellWaterWalking extends SpellShield {
    public SpellWaterWalking() throws DuplicateSpellException {
        super(Element.WATER, Element.EARTH, Names.Spells.WATER_WALKING);
    }
