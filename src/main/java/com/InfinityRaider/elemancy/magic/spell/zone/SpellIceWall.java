...
public final class SpellIceWall extends SpellZone {
    public SpellIceWall() throws DuplicateSpellException {
        super(Element.WATER, Element.WATER, Names.Spells.ICE_WALL);
    }
