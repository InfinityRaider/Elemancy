...
public final class SpellRingOfFlames extends SpellShield {
    public SpellRingOfFlames() throws DuplicateSpellException {
        super(Element.FIRE, Element.FIRE, Names.Spells.RING_OF_FLAMES);
    }
