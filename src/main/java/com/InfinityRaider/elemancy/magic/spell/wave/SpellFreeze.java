...
public final class SpellFreeze extends SpellWave {
    public SpellFreeze() throws DuplicateSpellException {
        super(Element.WATER, Element.EARTH, Names.Spells.FREEZE);
    }
