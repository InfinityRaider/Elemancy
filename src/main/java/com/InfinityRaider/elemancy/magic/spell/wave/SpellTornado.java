...
public final class SpellTornado extends SpellWave {
    public SpellTornado() throws DuplicateSpellException {
        super(Element.WATER, Element.AIR, Names.Spells.TORNADO);
    }
