...
public final class SpellEntangle extends SpellMelee {
    public SpellEntangle() throws DuplicateSpellException {
        super(Element.EARTH, Element.LIFE, Names.Spells.ENTANGLE);
    }
