...
public final class SpellPoisonNova extends SpellZone {
    public SpellPoisonNova() throws DuplicateSpellException {
        super(Element.WATER, Element.DEATH, Names.Spells.POISON_NOVA);
    }
