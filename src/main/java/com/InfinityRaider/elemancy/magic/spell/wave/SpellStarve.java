...
public final class SpellStarve extends SpellWave {
    public SpellStarve() throws DuplicateSpellException {
        super(Element.WATER, Element.DEATH, Names.Spells.STARVE);
    }
