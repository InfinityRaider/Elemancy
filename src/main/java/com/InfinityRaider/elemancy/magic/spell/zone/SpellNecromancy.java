...
public final class SpellNecromancy extends SpellZone {
    public SpellNecromancy() throws DuplicateSpellException {
        super(Element.LIFE, Element.DEATH, Names.Spells.NECROMANCY);
    }
