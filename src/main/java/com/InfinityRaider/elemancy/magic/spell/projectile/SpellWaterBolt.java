...
public final class SpellWaterBolt extends SpellProjectile {
    public SpellWaterBolt() throws DuplicateSpellException {
        super(Element.WATER, Element.DEATH, Names.Spells.WATER_BOLT);
    }
