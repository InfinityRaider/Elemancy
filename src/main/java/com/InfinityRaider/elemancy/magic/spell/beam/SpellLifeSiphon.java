...
public final class SpellLifeSiphon extends SpellBeam {
    public SpellLifeSiphon() throws DuplicateSpellException {
        super(Element.LIFE, Element.DEATH, Names.Spells.LIFE_SIPHON);
    }
