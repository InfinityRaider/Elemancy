...
public final class SpellTelekinesis extends SpellBeam {
    public SpellTelekinesis() throws DuplicateSpellException {
        super(Element.EARTH, Element.AIR, Names.Spells.TELEKINESIS);
    }
