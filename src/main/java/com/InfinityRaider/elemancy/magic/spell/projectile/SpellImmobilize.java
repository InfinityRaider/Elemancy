...
public final class SpellImmobilize extends SpellProjectile {
    public SpellImmobilize() throws DuplicateSpellException {
        super(Element.WATER, Element.EARTH, Names.Spells.IMMOBILIZE);
    }
