...
public final class SpellStoning extends SpellMelee {
    public SpellStoning() throws DuplicateSpellException {
        super(Element.EARTH, Element.EARTH, Names.Spells.STONING);
    }
