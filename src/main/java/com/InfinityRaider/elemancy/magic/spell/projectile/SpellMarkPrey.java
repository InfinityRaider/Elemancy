...
public final class SpellMarkPrey extends SpellProjectile {
    public SpellMarkPrey() throws DuplicateSpellException {
        super(Element.LIFE, Element.DEATH, Names.Spells.MARK_PREY);
    }
