...
public final class SpellSproutFlora extends SpellZone {
    public SpellSproutFlora() throws DuplicateSpellException {
        super(Element.EARTH, Element.LIFE, Names.Spells.SPROUT_FLORA);
    }
