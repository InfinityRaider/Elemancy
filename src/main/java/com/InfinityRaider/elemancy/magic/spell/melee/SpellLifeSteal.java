...
public final class SpellLifeSteal extends SpellMelee {
    public SpellLifeSteal() throws DuplicateSpellException {
        super(Element.LIFE, Element.DEATH, Names.Spells.LIFE_STEAL);
    }
