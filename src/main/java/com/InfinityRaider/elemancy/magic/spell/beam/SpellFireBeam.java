...
public final class SpellFireBeam extends SpellBeam {
    public SpellFireBeam() throws DuplicateSpellException {
        super(Element.FIRE, Element.FIRE, Names.Spells.FIREBEAM);
    }
