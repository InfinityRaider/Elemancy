...
public final class SpellDuplicate extends SpellProjectile {
    public SpellDuplicate() throws DuplicateSpellException {
        super(Element.WATER, Element.LIFE, Names.Spells.DUPLICATE);
    }
