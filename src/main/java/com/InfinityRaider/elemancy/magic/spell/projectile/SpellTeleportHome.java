...
public final class SpellTeleportHome extends SpellProjectile {
    public SpellTeleportHome() throws DuplicateSpellException {
        super(Element.LIFE, Element.LIFE, Names.Spells.TELEPORT_HOME);
    }
