...
public final class SpellPierceArmor extends SpellMelee {
    public SpellPierceArmor() throws DuplicateSpellException {
        super(Element.FIRE, Element.AIR, Names.Spells.PIERCE_ARMOR);
    }
