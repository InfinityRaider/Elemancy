...
public final class SpellConjureEnt extends SpellBeam {
    public SpellConjureEnt() throws DuplicateSpellException {
        super(Element.EARTH, Element.LIFE, Names.Spells.CONJURE_ENT);
    }
