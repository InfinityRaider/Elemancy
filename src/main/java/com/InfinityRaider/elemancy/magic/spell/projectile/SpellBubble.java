...
public final class SpellBubble extends SpellProjectile {
    public SpellBubble() throws DuplicateSpellException {
        super(Element.WATER, Element.AIR, Names.Spells.BUBBLE);
    }
