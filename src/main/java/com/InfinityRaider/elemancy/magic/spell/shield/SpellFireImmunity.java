...
public final class SpellFireImmunity extends SpellShield {
    public SpellFireImmunity() throws DuplicateSpellException {
        super(Element.FIRE, Element.LIFE, Names.Spells.FIRE_IMMUNITY);
    }
