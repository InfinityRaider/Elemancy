...
public final class SpellHallucinations extends SpellMelee {
    public SpellHallucinations() throws DuplicateSpellException {
        super(Element.AIR, Element.DEATH, Names.Spells.HALLUCINATIONS);
    }
