...
public final class SpellReflect extends SpellShield {
    public SpellReflect() throws DuplicateSpellException {
        super(Element.FIRE, Element.AIR, Names.Spells.REFLECT);
    }
