...
public final class SpellCursedFlames extends SpellWave {
    public SpellCursedFlames() throws DuplicateSpellException {
        super(Element.FIRE, Element.DEATH, Names.Spells.CURSED_FLAMES);
    }
