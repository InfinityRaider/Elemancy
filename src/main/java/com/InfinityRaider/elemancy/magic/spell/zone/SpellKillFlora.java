...
public final class SpellKillFlora extends SpellZone {
    public SpellKillFlora() throws DuplicateSpellException {
        super(Element.EARTH, Element.DEATH, Names.Spells.KILL_FLORA);
    }
